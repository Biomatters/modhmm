...
struct gengetopt_args_info
{
  ...
  char * target_arg;	/* sequence namefile (for seuences in fasta, smod, msamod or prfmod format).  */
  char * template_arg;	/* sequence namefile (for seuences in fasta, smod, msamod or prfmod format).  */
